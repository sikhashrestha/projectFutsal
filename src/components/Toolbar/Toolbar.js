...
import logo from '../../pages/assets/loggo.png'
      ...
      <nav className="toolbar__navigation">
        ...
        <div className="toolbar_navigation-items">
          ...
          <div className='logo'><img alt='anything' className='logocls' src={logo}/></div>
            ...
            <li  className='li'>
              <Link to="/bookingsmenu" id='resumemenu'   className='toolbaranchorcls bookingbug'>Bookings</Link>
            </li>
            <li  className='li'>
              <Link to="/aboutusmenu" id='skillsmenu'   className='toolbaranchorcls'>AboutUs</Link>
              </li>
              <li  className='li'>
              <Link to="/signupmenu" id='skillsmenu'   className='toolbaranchorcls'>Signup</Link>
              </li>
